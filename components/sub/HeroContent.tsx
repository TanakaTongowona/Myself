    ...
    className = 'flex flex-row items-center justify-center px-20 mt-40 w-full z-[20]'
      >
       <div className='h-full w-full flex flex-col gap-5 justify-center m-auto text-start'>
        ...
        <h1 className='Welcome-text text-[20px]'>Tanaka Tongowona Portifolio</h1>
        </motion.div>
        <motion.div 
        ...
        >
           <span>
           A data scientist 
           <span className='text-transparent bg-clip-text  bg-gradient-to-r from-purple-500 to-cyan-500'> and a tech </span> 
           student 
            </span>
        </motion.div>
        <motion.p
